...
public class LocalArtistRecyclerAdapter extends RecyclerView.Adapter<LocalArtistRecyclerAdapter.LocalArtistViewHolder> {
    ...
    public LocalArtistRecyclerAdapter(List<Artist> list, Context context) {
