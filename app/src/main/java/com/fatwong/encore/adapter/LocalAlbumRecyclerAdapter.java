...
public class LocalAlbumRecyclerAdapter extends RecyclerView.Adapter<LocalAlbumRecyclerAdapter.LocalAlbumViewHolder> {
    ...
    public LocalAlbumRecyclerAdapter(List<Album> list, Context context) {
        albumList = list;
        mContext = context;
    }
