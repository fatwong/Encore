...
public class PopupRecyclerAdapter extends RecyclerView.Adapter<PopupRecyclerAdapter.ListItemViewHolder> implements View.OnClickListener {

    private List<OverFlowItem> overFlowItemList;
    private Activity mContext;
    private OnRecyclerViewItemClickListener onItemClickListener;

    public PopupRecyclerAdapter(Activity context, List<OverFlowItem> list) {
